...
Public Class frmlabarugi

    Private Sub frmlabarugi_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Me.MdiParent = Form1
        keTengah(Form1, Me)
    ...
    End Sub
    Sub TampilGrid()
        DA = New OdbcDataAdapter("select * From tb_labarugi where tanggal ='" & Format(DateTimePicker2.Value, "yyyy-MM-dd") & "'", CONN)
        DS = New DataSet
        DA.Fill(DS, "labarugi")
    ...
    Private Sub Button2_Click(sender As System.Object, e As System.EventArgs) Handles Button2.Click
        ...
        reviewlabarugi.CrystalReportViewer1.SelectionFormula = "ToText({tb_labarugi1.Tanggal})='" & CDate(Format(DateTimePicker2.Value, "dd-MM-yyyy")) & "'"
        reviewlabarugi.CrystalReportViewer1.Refresh()
        reviewlabarugi.Show()
    End Sub
End Class