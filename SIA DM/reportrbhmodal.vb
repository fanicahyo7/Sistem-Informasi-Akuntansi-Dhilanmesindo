...
Public Class reportrbhmodal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIA_DM.reportrbhmodal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreportrbhmodal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As reportrbhmodal = New reportrbhmodal()
        rpt.Site = Me.Site
        Return rpt
    End Function
